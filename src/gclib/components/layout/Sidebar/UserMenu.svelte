<script lang="ts">
	...
	import { showSettings, activeUserIds, USAGE_POOL, mobile, showSidebar, user, settings, sdmMode } from '$lib/stores';
...
>
	...
	<slot name="content">
		...
		>
			...
			{#if ($settings?.sdmAllowed ?? false) || role === 'admin'}
				<div class="flex rounded-md py-1.5 px-3 w-full hover:bg-gray-50 dark:hover:bg-gray-800 transition">
					<div class="self-center mr-3">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							fill="none"
					...
					<div class="self-center truncate flex-grow">{$i18n.t('SDM Mode')}</div>
